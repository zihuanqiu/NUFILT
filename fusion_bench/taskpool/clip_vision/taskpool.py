...
class CLIPVisionModelTaskPool(
    ...
    def evaluate(
        ...
        **kwargs,
        ...
        for task_gt, (task_name, test_dataloader) in enumerate(pbar):
            ...
            task_samples = len(test_dataloader.dataset)
        ...
        overall_throughput = total_samples / elapsed_time
        print(f"\n[Overall] Total samples: {total_samples}")
        print(f"[Overall] Total time: {elapsed_time:.2f} sec")
