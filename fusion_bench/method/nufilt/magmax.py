...
from fusion_bench.method.ties_merging.ties_merging_utils import (
    magmax_merging, state_dict_to_vector, vector_to_state_dict)
...
class MagMaxForCLIP(BaseAlgorithm, LightningFabricMixin):
    def __init__(
        self,
    ...
    def run(self, modelpool: BaseModelPool):
        ...
        for model_idx, model_name in tqdm(
            ...
            if model_idx == 0:
                ...
                # perform the MagMax merging
                ties_merging_tv = magmax_merging(tv_flat_checks)
