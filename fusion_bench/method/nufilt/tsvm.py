...
class ContinualTSVMForCLIP(BaseAlgorithm, LightningFabricMixin):
    def __init__(
        self,
    ...
    def run(self, modelpool: BaseModelPool):
        ...
        for model_idx, model_name in tqdm(
            ...
            if model_idx == 0:
                ...
                merging_state_dict = task_vector
            else:
                ...
                merging_state_dict = TSVM_utils.compute_and_sum_svd_mem_reduction(
                    [merged_tv, task_vector],
            ...
            for param_name, param in task_model.named_parameters():
                ...
                new_param = (
                    pretrained_param
                    + self.scaling_factor * merging_state_dict[param_name]
                )
